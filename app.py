...
from persona_engine import generate_dna_persona
# import ezdxf
...
SCENARIO_DATA = load_scenario_data('scenario_canadawater.json')
...
def view_3d():
    ...
    return send_from_directory('new_3d_pipeline/frontend_threejs', 'index.html')

@app.route('/3d/<path:filename>')
def serve_3d_assets(filename):
    """Serves static assets for the 3D view."""
    return send_from_directory('new_3d_pipeline/frontend_threejs', filename)
...
def get_3d_layer(layer_name):
    ...
    geojson_path = os.path.join('new_3d_pipeline', 'data_cleaned', f"{layer_name}.geojson")
...
def get_masterplan_data():
    ...
    path = os.path.join('new_3d_pipeline', 'masterplan_data.json')
